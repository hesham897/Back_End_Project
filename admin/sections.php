...
if (!empty($_GET['delete'])) {
    ...
    echo "<script> window.location='http://localhost:8080/FullStack/Backend/sections.php'</script>";
    die;
}
try {
            ...
            <tbody>
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td><?= $user['Name'] ?></td>
                        <td>
                            <a href="http://localhost:8080/FullStack/Backend/admin/sections-edit.php?id=<?= $user['ID'] ?>" class="btn btn-sm btn-primary">Edit</a>
